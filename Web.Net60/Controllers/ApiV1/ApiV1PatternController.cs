...
namespace MurrayGrant.MakeMeAPassword.Web.Net60.Controllers.ApiV1
{
    ...
    public class ApiV1PatternController : ApiV1Controller
    {
        ...
        public ApiV1PatternController(PooledEntropyCprngGenerator terninger, PasswordRatingService ratingService, PasswordStatisticService statisticService, DictionaryService dictionaryService)
            : base(terninger, ratingService, statisticService, dictionaryService) { }

        [HttpGet("/api/v1/pattern/plain")]
        public IActionResult Plain([FromQuery]int? gs, [FromQuery]int? ps, [FromQuery]int? c)
        {
        ...
        public IActionResult Json([FromQuery]int? gs, [FromQuery]int? ps, [FromQuery]int? c)
        {
        ...
        public IActionResult Xml([FromQuery]int? gs, [FromQuery]int? ps, [FromQuery]int? c)
        {
            // Return as XML.
            using (var random = _Terninger.CreateCypherBasedGenerator())
            {
        ...
        public ActionResult Combinations([FromQuery] int? gs, [FromQuery] int? ps)
        {
            ...
            var result = new JsonCombinationContainer()
            {
                ...
                rating = _RatingService.RatePattern(combinations),
            };
            return Json(result);
        }
