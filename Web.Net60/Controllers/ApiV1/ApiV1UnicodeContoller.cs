...
namespace MurrayGrant.MakeMeAPassword.Web.Net60.Controllers.ApiV1
{
    ...
    public class ApiV1UnicodeController : ApiV1Controller
    {
        ...
        public ApiV1UnicodeController(PooledEntropyCprngGenerator terninger, PasswordRatingService ratingService, PasswordStatisticService statisticService, DictionaryService dictionaryService
        ...
        public IActionResult Plain([FromQuery]int? l, [FromQuery]int? c, [FromQuery]string bmp, [FromQuery]string asian)
        {
        ...
        public IActionResult Json([FromQuery]int? l, [FromQuery]int? c, [FromQuery]string bmp, [FromQuery]string asian)
        {
        ...
        public IActionResult Xml([FromQuery]int? l, [FromQuery]int? c, [FromQuery]string bmp, [FromQuery]string asian)
        {
            // Return as XML.
            using (var random = _Terninger.CreateCypherBasedGenerator())
            {
        ...
        public ActionResult Combinations([FromQuery]int? l, [FromQuery]string bmp, [FromQuery]string asian)
        {
            ...
            var combinations = Math.Pow(keyspace, length);
